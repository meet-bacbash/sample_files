...
class RFClassifier(KnnClassifier):

    def train_and_apply_model(self, x_train: np.ndarray, y_train: np.ndarray) -> RandomForestClassifier:
        """
        ...
        _model = RandomForestClassifier(**self.params)
...
if __name__ == "__main__":
    ...
    output_business_data.get("output_dataframe").to_csv("/home/bacancy/Downloads/imputed_rf.csv")
